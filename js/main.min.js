...
window.addEventListener('DOMContentLoaded', function () {
  var aboutVideo = document.querySelector('[data-video="about-video"]');
  var aboutPlayVideo = document.querySelector('[data-button="play-video"]');
  var aboutVideoPreview = document.querySelector('[data-video-preview]');
  ...
  window.addEventListener('load', function () {
    aboutPlayVideo.addEventListener('click', function () {
      aboutVideoPreview.style.display = 'none';
      var videoSrc = aboutVideo.getAttribute('src');
